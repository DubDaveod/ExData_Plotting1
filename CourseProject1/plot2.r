...
sub <- cbind(sub, datetimedays=paste(sub$datetime, weekdays(sub$datetime, abbreviate=TRUE))) 

with (sub, plot( Global_active_power ,ylab="Global Active Power (kilowatts)", type="l", main="Plot 2"))
